...
export function loadPage(pagePath, opts = {}) {
  ...
  const ids = ['pageSched', 'pageChat', 'tabSched', 'tabChat', 'chatDot',
    'datePick', 'list', 'notifyRow', 'wkBar', 'wkPrev', 'wkNext', 'wkLabel', 'wkNowBtn', 'weekGrid', 'notifyBtn', 'notifyState', 'chatLog', 'chatThumbs', 'chatIn', 'chatAttach', 'chatSend', 'chatFile', 'modelBtn', 'newChatBtn', 'dDel', 'pIn', 'pOk', 'pCancel', 'pMsg', 'dWeekPattern', 'dWeekPatternWrap', 'dSkip', 'dTaskStart', 'dTaskStartWrap'];
